...
<h2 class="mb-3"><?php echo $user['displayName'] ?>&nbsp;<i style="font-size:15px; color:#33cc33;vertical-align:middle;"
        class="fas fa-circle" title="Đang online"></i></h2>
    ...
    <div class="card-body">
        ...
        <p class="card-text">
            <img class="rounded-circle" style="width:40px;height:40px;"
                src="<?php echo empty($user['avatarImage']) ? './assets/images/default-avatar.jpg' : 'view-image.php?userId=' . $user['id']; ?>"
                alt="<?php echo $user['displayName'] ?>">

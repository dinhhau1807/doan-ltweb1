...
<div id="message-wrapper">
    <div class="message-box d-flex flex-column">
        ...
        <div class="px-3 py-2">
            <img id="toUserImage" class="rounded-circle" style="width:60px;height:60px;" />
            <div class="d-inline-block text-success pl-2">
                <h5 id="toUserName" class="mb-2"></h5>
            </div>
            <hr />
        </div>
        <div class="messages">
        ...
        <div class="message-bar hover-secondary" data-toUserId="<?php echo $conversation['id']; ?>">
            <div class="
                ...
                <div class="d-inline-block text-success pl-2">
                    ...
                    <small class="custom-time">Tin nhắn cuối:
                        <?php echo $conversation['lastMessage']['createdAt'] ?></small>

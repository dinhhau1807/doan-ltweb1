                                            ...
                                            <div class="btn-group" id="select-policy">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <a style="pointer-events:none;" class="dropdown-item">Ai sẽ thấy bài viết
                                                        này?</a>
                                                    <li data-postId="<?php echo $post['id']; ?>" data-roleId="1"><a class="dropdown-item" href="#"><i class="fas fa-globe-americas"></i>
                                                            &nbsp;<strong> Công khai</strong></a></li>
                                                    <li data-postId="<?php echo $post['id']; ?>" data-roleId="2"><a class="dropdown-item" href="#"><i class="fas fa-user-friends"></i>&nbsp;<strong> Bạn bè</strong></a>
                                                    </li>
                                                    <li data-postId="<?php echo $post['id']; ?>" data-roleId="3"><a class="dropdown-item" href="#"><i class="fas fa-lock"></i>&nbsp;<strong>
